 ...
 *
 * File:   main.cc
 * Author: Nahian Afsari
 * Email:  nxa161730@utdallas.edu
 */
...
int main()
{
  ...
  */
  ...
  binInfile.read((char*)headers, sizeof(BinaryFileHeader));
  string magic = "Magic:0x";
  stringstream ss;
  ss<<hex<<uppercase<<headers->magicNumber;
  magic+= ss.str();
  
  string version = "Version:";
  stringstream ss1;
  ss1<<headers->versionNumber;
  version+= ss1.str();
